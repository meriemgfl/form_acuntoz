function MyForm1() {
    ...
    return (
        ...
        <div className="mb-4">
        <label className="block text-left text-gray-700 font-bold mb-2">Proposed start date *</label>
        ...
        <div className="mb-4">
        <label className="block text-left text-gray-700 font-bold mb-2">Proposed end date *</label>
        <div className="flex justify-between items-center text-red-600">
        ...
        <div className="mb-4">
        <label className="block text-left text-gray-700 font-bold mb-2">Duration Type</label>
        <div className="flex justify-between items-center text-red-600">
        ...
        <div className="mb-4">
        <label className="block text-left text-gray-700 font-bold mb-2">Proposed issue date</label>
        <div className="flex justify-between items-center text-red-600">
        ...
        <div className="mb-4">
        <label className="block text-left text-gray-700 font-bold mb-2">Budget type</label>
        <div className="flex justify-between items-center text-red-600">
        ...
        <div className="mb-4">
        <label className="block text-left text-gray-700 font-bold mb-2">Enter amount</label>
        <div className="flex justify-between items-center text-red-600">
        ...
        <button onClick={onNext} type="submit" className="bg-yellow-600 text-white py-2 px-4 rounded hover:bg-yellow-700 focus:outline-none focus:shadow-outline"><span>Save & Next</span></button>
        </div>
        </div>
        </div>
        </form>
